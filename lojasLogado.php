    ...
    <nav class="desktop nav d-flex align-items-center bg-danger" style="height: 12vh; box-shadow: 2px 2px 10px black; ">
        ...
        <div class="d-flex col-lg-9">
            ...
            <div class="d-flex justify-content-end col-lg-10">
                ...
                <a class="nav-link2 font-weight-bold text-white text-center col-lg-2" style="font-size: 20px; color: black !important; background-color: rgba(228, 220, 220, 0.651); border-radius: 20px;" href="lojasLogado.php">Lojas</a>
