            ...
            <div class="row d-flex align-items-center justify-content-center;">
                ...
                <form class="col-12 col-sm-12 col-md-8 col-lg-4 col-xl-4 p-4 mx-auto" action="" style="background-color: #ffffff;  box-shadow: 5px 5px 2px black;">
                    ...
                    <div class="text-center mt-4">
                        <a href=""><img class="mx-2" src="./imgs/svgs/wpp.svg" alt=""></a>
                        <a href=""><img class="mx-2" src="./imgs/svgs/instagram.svg" alt=""></a>
                        <a href=""><img class="mx-2" src="./imgs/svgs/twitter.svg" alt=""></a>
                        <a href=""><img class="mx-2" src="./imgs/svgs/github.svg" alt=""></a>
                        <a href=""><img class="mx-2" src="./imgs/svgs/email.svg" alt=""></a>
                    </div>
                </form>
